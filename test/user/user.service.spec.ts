...
//       module.get<ProfessionalsService>(ProfessionalsService);

//     jest
//       .spyOn(UserUtil, 'mapUserRole')
//       .mockImplementation((role) => UserRole.USER);
...
//       const userExistsRequestDto: UserExistsRequestDto = {
