...
export class Migration20250930000001_AddCidadeAndContatosToUsuario extends Migration {
  override async up(): Promise<void> {
    ...
    // Adicionar foreign key cidade_id → cidade
    this.addSql(
    ...
    // Criar tabela pivot usuario_contato
    ...
    // Criar índices para a tabela pivot
    this.addSql(
  ...
  override async down(): Promise<void> {
    ...
    // Remover foreign key e campo cidade_id de usuario
    this.addSql(
