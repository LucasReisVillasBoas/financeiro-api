...
export class Migration20250811133830 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table "endereco" ("id" serial primary key, "cep" varchar(8) not null, "logradouro" varchar(60) not null, "numero" varchar(60) not null, "bairro" varchar(60) not null, "complemento" varchar(60) null, "cidade" varchar(60) not null, "codigo_ibge" varchar(7) not null, "uf" varchar(2) not null, "ativo" boolean not null default true, "deletado_em" timestamptz null, "criado_em" timestamptz not null, "atualizado_em" timestamptz not null);`);

    this.addSql(`create table "empresa" ("id" serial primary key, "matriz_id" int null, "endereco_id" int not null, "razao_social" varchar(60) not null, "nome_fantasia" varchar(60) null, "cnpj_cpf" varchar(14) not null, "inscricao_estadual" varchar(14) null, "inscricao_municipal" varchar(15) null, "site" varchar(60) null, "matriz_filial" varchar(1) null, "abertura" timestamptz not null, "ativo" boolean not null default true, "deletado_em" timestamptz null, "criado_em" timestamptz not null, "atualizado_em" timestamptz not null);`);
    this.addSql(`create index "empresa_matriz_id_index" on "empresa" ("matriz_id");`);
    this.addSql(`create index "empresa_endereco_id_index" on "empresa" ("endereco_id");`);

    this.addSql(`create table "tipo_contato" ("id" serial primary key, "nome" varchar(50) not null, "corporativo" boolean not null default false);`);

    this.addSql(`create table "contato" ("id" serial primary key, "entity_type" varchar(50) not null, "entity_id" int not null, "tipo_contato_id" int not null, "descricao" varchar(100) not null, "ativo" boolean not null default true, "deletado_em" timestamptz null, "criado_em" timestamptz not null, "atualizado_em" timestamptz not null);`);
    ...
    this.addSql(`create table "empresa_usuario" ("id" serial primary key, "empresa_id" int not null, "usuario_id" int not null, "criado_em" timestamptz not null, "atualizado_em" timestamptz not null);`);
